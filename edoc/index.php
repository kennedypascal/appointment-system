...
<body>
    ...
    <div class="full-height">
        ...
        <table border="0">
            ...
            <tr>
                <td  colspan="3">
                    <p class="heading-text">Avoid the delays and Disappointments</p>

                </td>
            </tr>
            <tr>
                <td  colspan="3">
                    <p class="sub-text2">Health today is everything, i know you agree!<br>Don't worry. Find your doctor online Book an appointment as and when with eSURG. <br>
                    We let you know when your doctor is free, all you do is walk in and get it done with.</p>
                </td>
            </tr>
            <tr>
        ...
        <p class="sub-text2 footer-hashen">A Web Solution by EQUITEK.</p>
    </center>
