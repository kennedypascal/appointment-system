...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>e-SURG Surgery Request Page</title>
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title">Surgery Request Form</h4>
      ...
      <?php $query=mysqli_query($con,"select * from tblcategory");
              ...
              <option value="<?php echo $row['VehicleCat'];?>"><?php echo $row['VehicleCat'];?></option>
                  <?php } ?>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label" for="example-email">Surgery Name</label>
                                                        <div class="col-10">
                                                            <input type="text" id="vehiclename" name="vehiclename" class="form-control" placeholder="Name of Surgery" required="true">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label">Surgery Type</label>
                                                        <div class="col-10">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label">Surgery Classifications</label>
                                                        <div class="col-10">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label">Surgery Date</label>
                                                        <div class="col-10">
