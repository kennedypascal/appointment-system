...
?>
  ...
  <head>
    <meta charset="utf-8" />
    <title>Lekma Hospital Enquiry History View Page</title>
        ...
        <div class="content">
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-12">
                <div class="card-box">
                  <h4 class="m-t-0 header-title">Lekma Hospital Enquiry History View</h4>
                        ...
                        <form method="post">
                          ...
                          ?>
                            ...
                            <table border="1" class="table table-bordered mg-b-0">
                              ...
                              <tr>
                                <th>Lekma Hospital Admin Response</th>
                                <td><?php
