                    ...
                    <div class="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card-box">
                                        <h4 class="header-title mb-4">Welcome Back to Lekma Hospital Patient panel !</h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-lg-6 col-xl-3">
                                                <div class="card-box mb-0 widget-chart-two">
                                                    ...
                                                    <div class="widget-chart-two-content">
                                                        <p class="text-muted mb-0 mt-2">Total Appointment Requests</p>
                                            ...
                                            <div class="col-sm-6 col-lg-6 col-xl-3">
                                                <div class="card-box mb-0 widget-chart-two">
                                                    ...
                                                    <div class="widget-chart-two-content">
                                                        <p class="text-muted mb-0 mt-2">New Appointment Requests</p>
                                            ...
                                            <div class="col-sm-6 col-lg-6 col-xl-3">
                                                <div class="card-box mb-0 widget-chart-two">
                                                    ...
                                                    <div class="widget-chart-two-content">
                                                        <p class="text-muted mb-0 mt-2">Rejected Appointment Requests</p>
                                            ...
                                            <div class="col-sm-6 col-lg-6 col-xl-3">
                                                <div class="card-box mb-0 widget-chart-two">
                                                    ...
                                                    <div class="widget-chart-two-content">
                                                        ...
                                                        <p class="text-muted mb-0 mt-2">Completed Appointment </p>
