...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Adwoa Boatemaa Memorial Clinic Surgeons Edit Page</title>
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title">Update Surgeons Details</h4>
    ...
    echo $msg;
                                               ...
                                               <form class="form-horizontal" role="form" method="post" name="submit">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label" for="example-email">Surgeon Name</label>
                                                        <div class="col-10">
                                                      ...
                                                      <div class="form-group row">
                                                        <label class="col-2 col-form-label" for="example-email">Surgeon Contact Number</label>
                                                        <div class="col-10">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label" for="example-email">Surgeon Email</label>
                                                        <div class="col-10">
...
<div class="form-group row">
                                                        <label class="col-2 col-form-label" for="example-email">Surgeon Address</label>
                                                        <div class="col-10">
