...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Lekma Admin Dashboard</title>
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title mb-4">Lekma Hospital Admin Overview</h4>
...
?>
                                                ...
                                                <div class="widget-chart-two-content">
                                                    ...
                                                    <p class="text-muted mb-0 mt-2">Total Registered Patients</p>
...
?>
                                                ...
                                                <div class="widget-chart-two-content">
                                                    <p class="text-muted mb-0 mt-2">Total Surgery Enquiry</p>
...
?>
                                                ...
                                                <div class="widget-chart-two-content">
                                                    <p class="text-muted mb-0 mt-2">Total surgeons</p>
...
?>
                                                ...
                                                <div class="widget-chart-two-content">
                                                    <p class="text-muted mb-0 mt-2">Total Doctors</p>
 ...
 ?>
             ...
             <div class="widget-chart-two-content">
                 <p class="text-muted mb-0 mt-2">Total Surgery Requests</p>
...
?>
                                                ...
                                                <div class="widget-chart-two-content">
                                                    <p class="text-muted mb-0 mt-2">New Surgery Requests</p>
...
?>
                                                ...
                                                <div class="widget-chart-two-content">
                                                    <p class="text-muted mb-0 mt-2">Rejected Surgery Requests</p>
...
?>
                                                ...
                                                <div class="widget-chart-two-content">
                                                    ...
                                                    <p class="text-muted mb-0 mt-2">Completed Surgery </p>
