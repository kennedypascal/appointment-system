...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Adwoa Boatemaa Memorial Clinic View Surgery Page</title>
...
<tr>
    <th>Location/Address of Patients</th>
    <td>
        <?php
...
<td>
  ...
  <tr align="center">
    <td colspan="2"><button type="submit" name="submit" class="btn btn-az-primary pd-x-20">Surgery Completed</button></td>
  </tr>
  </form>
<?php } else { ?>
