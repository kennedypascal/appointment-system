...
if(isset($_POST['submit']))
 ...
 $pickupby=$_POST['pick'];
   ...
   $query=mysqli_query($con, "update  tblservicerequest set AdminStatus='$admsta', PickupBy='$pickupby' where ID='$cid'");
    if ($query) {
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Adwoa Boatemaa Memorial Clinic View Surgery Request Page</title>
...
<?php } ?>
        ...
        // send email
        mail("chaithanyaheblikar26@gmail.com","My subject",$msg);
        ?>
