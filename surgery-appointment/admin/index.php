...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Adminstrators Login Page</title>
    ...
    <body class="account-pages">
        ...
        <!-- Begin page -->
        <div class="accountbg" style="background: url('assets/images/admin_login.png');background-size: cover;background-position: center;"></div>
