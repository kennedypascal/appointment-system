...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con,"select ID from tblpickup where  Email='$email' and  MobileNumber ='$mobno' ");
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>e-SURG Forget Password Page</title>
    ...
    <body class="account-pages">
        ...
        <!-- Begin page -->
        <div class="accountbg" style="background: url('assets/images/forget.png');background-size: cover;background-position: center;"></div>
                        ...
                        <div class="card-box p-5">
                            <h3 class="text-uppercase text-center pb-4">
                                <a href="../index.php" class="text-success">
                                    <span>e-SURG | Recover Password</span>
                                </a>
                            </h3>
