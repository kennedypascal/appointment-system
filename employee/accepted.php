...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Lekma Hospital Accepted Page</title>
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title">Accepted Requests</h4>
...
?>
                ...
                <tr>
                  ...
                  <td><a href="aview.php?aticid=<?php echo $row['apid'];?>">View Details</a></td>
                </tr>
                <?php
$cnt=$cnt+1;
}?>
