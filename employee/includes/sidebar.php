              ...
              <div class="slimscroll-menu" id="remove-scroll">
                  ...
                  <div class="user-box">
                      <div class="user-img">
                       ...
                       <?php
$uid=$_SESSION['eid'];
$ret=mysqli_query($con,"select FullName from tblpickup where ID='$uid'");
...
<li>
                              <a href="javascript: void(0);"><i class="fi-layers"></i><span> Pickup Request </span> <span class="menu-arrow"></span></a>
                              <ul class="nav-second-level" aria-expanded="false">
                                  <li><a href="pickup-request.php">New</a></li>
