...
$query=mysqli_query($con,"update tblpickup set Password ='$newpassword' where  Email='$email' && MobileNumber = $mobno ");
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Lekma Hospital | Reset Password</title>
                        ...
                        <div class="card-box p-5">
                            <h3 class="text-uppercase text-center pb-4">
                                <a href="../index.php" class="text-success">
                                    <span>Lekma Hospital | Reset Password</span>
                                </a>
                            </h3>
