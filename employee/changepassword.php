...
$query=mysqli_query($con,"select ID from tblpickup where ID='$empid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tblpickup set Password='$newpassword' where ID='$empid'");
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Lekma Hospital change Password Page</title>
