...
<!doctype html>
  <html lang="en">
      ...
      <body class="account-pages">
          ...
          <!-- Begin page -->
          <div class="accountbg" style="background: url('assets/images/doctors_login.png');background-size: cover;background-position: center;"></div>
                          ...
                          <div class="card-box p-5">
                              <h3 class="text-initial text-center pb-4">
                                  <a href="../index.php" class="text-success">
                                      <span> e-SURG | Doctors Login</span>
                                  </a>
                              </h3>
